...
fileName = './files/seqNumAll2D.txt'
...
lrScheduler = lr_scheduler.StepLR(optimizer, step_size=150, gamma=0.5)
# train model with 100 epoch
trainMSModel(dataLoaders, model, optimizer, lrScheduler, earlyStopNumber=50, numEpochs=400, modelN = modelName)
