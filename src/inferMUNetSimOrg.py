...
def main():
    ...
    networkName = 'MUNet'
    modelName = args.model + '-' + networkName
    ...
    folderData = sorted(glob.glob(basedir + "/" + sequence_id + "/*.tif"))
    ...
    outputPath = dataset + "-" + networkName + "-SimOrg"
    
    
    # set mask path
    maskDir = os.path.join('./output/' + data_type + '/' + outputPath + "/" + sequence_id + '/Mask/')
    # create path if not exist
    if not os.path.exists(maskDir):
        os.makedirs(maskDir)
    
    # set mask path
    markerDir = os.path.join('./output/' + data_type + '/' + outputPath + "/" + sequence_id + '/Marker/')
    # create path if not exist
    if not os.path.exists(markerDir):
        os.makedirs(markerDir)
        
    # set mask path
    outDir = os.path.join('./output/' + data_type + '/' + outputPath + "/" + sequence_id + '/Label')
    # create path if not exist
